...
use forma_core::form::{FormSchema, Schema};
use forma_core::schema::{DynSchema, FieldMeta, ShapeNode};
    ...
    pub fn new() -> Self {
        Self {
            object: ::forma_core::types::object()
                .field("q", ::forma_core::types::string()),
        }
    }
}
...
impl DynSchema for InnerSchema {
    fn validate_value(&self, _v: &Value) -> Vec<forma_core::error::FormaIssue> {
        Vec::new()
    }
